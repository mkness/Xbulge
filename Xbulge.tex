...
%and the ubiquitity of these bulges in barred spiral galaxies highlights the important role internal evolution plays in bulge formation in spiral galaxies. 

%We present a WISE image of the Milky Way bulge, produced by downsampling the publicly available ``unWISE'' coadds.  

%This data used to create this image that we present is publicly available and can be readily accessed by the community for further analysis of the nature of the X-shaped bulge of the Milky Way. 
